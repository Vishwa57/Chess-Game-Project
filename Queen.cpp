...
// Used to return the queen symbol.
string Queen::getSymbol(bool pieceColour) {
    if (pieceColour == true) {
        return "♕";
    } else {
        return "♛";
...
// Checks if the queen is moving to a legal square
bool Queen::canMove(string *&Arr, bool colour, int startx, int starty, int endx, int endy) {
