...
// Used to return the rook symbol.
string Rook::getSymbol(bool pieceColour) {
    if (pieceColour == true) {
        return "♖";
    } else {
        return "♜";
...
// Checks if the rook is moving to a legal square
bool Rook::canMove(string *&Arr, bool colour, int startx, int starty, int endx, int endy) {
